...
class PreferencesManager private constructor(private val context: Context) {
    ...
    companion object {
        // Suprimindo o aviso, uma vez que usamos aaplicationContext, que segundo a documentação
        // é um contexto único que persiste duranto todo o ciclo de vida da aplicação.
        // Dessa maneira, não existe vazamento de memória
